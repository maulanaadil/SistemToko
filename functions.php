...
// function menghitung total transaksi
...
// function menghitung total barang
function getTotalBarang()
{
  $db = dbConnect();
  $sql = "SELECT COUNT(kode_barang) as total FROM barang";
  return $db->query($sql);
}
...
function ubahBarang($kodeBarang, $namaBarang, $harga, $stok)
{
  return "UPDATE barang SET kode_barang = '$kodeBarang', nama_barang = '$namaBarang', harga = '$harga', stok = '$stok' WHERE barang.kode_barang = '$kodeBarang'";
}

function getHapusBarang($kode_barang)
{
  return "DELETE FROM barang WHERE kode_barang = '$kode_barang'";
}
...
//function untuk query mengambil data total barang yang stok=0
function getDataTotalBarangKosong()
{
  $db = dbConnect();
  $sql = "SELECT COUNT(*) FROM barang WHERE stok=0";
  return $db->query($sql);
}
...
{
  $db = dbConnect();
  $sql = 'SELECT pegawai.nama_pegawai AS np, transaksi.tgl_transaksi AS tgl, barang.nama_barang AS nb, barang.harga AS h, detail_transaksi.jml_beli AS jt, transaksi.total AS t, transaksi.id_transaksi AS it
  FROM pegawai
  INNER JOIN 
      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              <a href="home.php" class="nav-link <?php echo ($judul == 'Data Barang' ? "active" : "") ?>">
            ...
            <li class="nav-item">
              <a href="barang/tampilan-barang.php"
                class="nav-link <?php echo ($judul == 'Data Barang' ? "active" : "") ?>">
            ...
            <li class="nav-item">
              <a href="transaksi/tampilan-transaksi.php"
                class="nav-link <?php echo ($judul == "Transaksi" ? "active" : "") ?>">
            ...
            <li class="nav-item">
              <a href="laporan/tampilan-laporan-barang.php"
                class="nav-link <?php echo ($judul == "Laporan Barang Kosong" ? "active" : "") ?>">
      ...
      <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
          ...
          <div class="sidebar">
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
              <div class="info" data-widget="treeview">
                <a class="d-block"> <span class="fa fa-user mr-3"></span>Halo,
                  <?php echo $_SESSION["nama_pegawai"] ?></a>
              </div>
            </div>
